				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						...
						<div class="contact-form">
							<form action="{{route('submit.contact_form')}}" method="post">
							@csrf
								<div class="form-group mt-1">
									<label class="control-label">Full Name*</label>
									<div class="ui search focus">
										<div class="ui left icon input swdh11 swdh19">
											<input class="prompt srch_explore" type="text" name="contact_name" required="" placeholder="Your Full Name">															
										</div>
									</div>
								</div>
								<div class="form-group mt-1">
									...
									<div class="ui search focus">
										<div class="ui left icon input swdh11 swdh19">
											<input class="prompt srch_explore" type="email" name="contact_email" required="" placeholder="Your Email Address">															
										</div>
									</div>
								</div>
								<div class="form-group mt-1">
									...
									<div class="ui search focus">
										<div class="ui left icon input swdh11 swdh19">
											<input class="prompt srch_explore" type="text" name="contact_subject" required="" placeholder="Subject">															
										</div>
									</div>
								</div>
								<div class="form-group mt-1">	
									<div class="field">
										...
										<textarea rows="2" class="form-control" name="contact_message" required="" placeholder="Write Message"></textarea>
									</div>
								</div>
								@if(session()->has('contact_result'))
								<div class="form-group mt-1">	
									<div class="field">
						        ...
						        @endif
								<button class="next-btn16 hover-btn" type="submit">Submit Request</button>
							</form>
						</div>
					</div>
				</div>
