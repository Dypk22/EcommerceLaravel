			...
			<div class="container">
						...
						<div class="product-top-dt">
							...
							<div class="product-sort float-left float-md-right">
								<div class="ui selection dropdown vchrt-dropdown">
									...
									<div class="menu">
										<div class="item" onclick="item_sort('popularity','{{$sort}}','latest-products','{{$page}}')" data-value="0">Popularity</div>
										<div class="item" onclick="item_sort('price_high','{{$sort}}','latest-products','{{$page}}')" data-value="1">Price - Low to High</div>
										<div class="item" onclick="item_sort('price_low','{{$sort}}','latest-products','{{$page}}')" data-value="2">Price - High to Low</div>
										<div class="item" onclick="item_sort('name','{{$sort}}','latest-products','{{$page}}')" data-value="3">Alphabetical</div>
										<div class="item" onclick="item_sort('date','{{$sort}}','latest-products','{{$page}}')" data-value="4">Date</div>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="product-list-view">
					<div class="row showRow">
						...
						@endforeach
						@if($product->count()==0) <script type="text/javascript">window.location.href='/latest-products';</script> @endif
						<div class="col-md-12">
