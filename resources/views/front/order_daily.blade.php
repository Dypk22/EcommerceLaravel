...
@section('home_active','')
@section('page_title','Grockart | Schedule Your Daily Order')
@section('container')
	<!-- Body Start -->
	<div class="wrapper">
					...
					<div class="col-lg-4 col-md-5">
						<div class="pdpt-bg mt-0">
							...
							<div class="main-total-cart">
								<h2 id="afterfinaldailyprice">Total</h2>
								<span class="carttotalPrice" id="finaldailyprice" data-position="bottom center" data-tooltip="Payable Amount ₹{{$totalPrice*7}}">₹{{$totalPrice}} X 7 Days</span>
							</div>
						...
						<div id="checkout_wizard" class="checkout accordion left-chck145">
							...
							@php $temp='ok';@endphp
								...
								<div id="collapseFirst" class="collapse in show" data-parent="#checkout_wizard">
									<div class="checkout-step-body">
										<p><a data-toggle="modal" data-target="#login_modal" class="color-tomato order_daily_margin_left" href="javascript:void(0)">Click here to sign in</a></p>	
									</div>
								</div>
							</div>
							@endif()
							...
							<div class="checkout-step">
								<div class="checkout-card" id="headingThree"> 
									...
									<h4 class="checkout-step-title">
										<button class="wizard-btn collapsed" id="collapseThreeHead" disabled="" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree"> Delivery Schedule</button>
									</h4>
								</div>
								<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#checkout_wizard">
									<div class="checkout-step-body">
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label class="control-label">Select Date To Start Daily Delivery*</label>
													...
													<label class="control-label mb-0 mt-2">Select Delivery Timing*</label>
													...
													<label class="control-label mb-0 mt-2">Days to be Deliverered*</label>
													<div class="time-radio">
														<div class="ui form">
															<div class="grouped fields">
																<div class="field">
																	<div class="ui radio checkbox chck-rdio">
																		<input type="radio" checked="" name="delivery_days" id="next 7 days" value='next 7 days' tabindex="0" class="hidden">
																		<label for="next 7 days" onclick="delivery_days('7')">Next 7 Days</label>
																	</div>
																</div>
																<div class="field">
																	<div class="ui radio checkbox chck-rdio">
																		<input type="radio" name="delivery_days" id="next 15 days" value='next 15 days' tabindex="0" class="hidden">
																		<label for="next 15 days" onclick="delivery_days('15')">Next 15 Days</label>
																	</div>
																</div>
																<div class="field">
																	<div class="ui radio checkbox chck-rdio">
																		<input type="radio" name="delivery_days" id="next 21 days" value='next 21 days' tabindex="0" class="hidden">
																		<label for="next 21 days" onclick="delivery_days('21')">Next 21 Days</label>
																	</div>
																</div>
																<div class="field">
																	<div class="ui radio checkbox chck-rdio">
																		<input type="radio" name="delivery_days" id="next 30 days" value='next 30 days' tabindex="0" class="hidden">
																		<label for="next 30 days" onclick="delivery_days('30')">Next 30 Days</label>
																	</div>
																</div>
																<div class="field">
																	<div class="form-group">
																		<label class="control-label">Or Enter Days To Be Delivered*</label>
																		<!-- <input id="buyername" name="name" type="text" placeholder="Full Name" class="form-control input-md" required=""> -->
																	<input type="number" class="form-control input-md col-md-6" placeholder="Days" onchange="delivery_days(value)">
																	</div>
																</div>
															</div>
														</div>
										...
										<div class="payment_method-checkout">	
											<div class="row">	
												<div class="col-md-12">
														...
														<ul class="radio--group-inline-container_1">
															<li>
																<div class="radio-item_1">
																	<input id="cashondelivery1" disabled="" value="CashOnDelivery" name="paymentmethod" type="radio">
																	<label for="cashondelivery1" class="radio-label_1"><span data-tooltip="Not Availabble this Payment Method" data-inverted="" data-position="top center">Cash on Delivery</span></label>
																</div>
															</li>
															<li>
																<div class="radio-item_1">
																	<input id="card1" checked="" value="PaymentGateway" name="paymentmethod" type="radio">
															...
															<li id="removePrevBalDivList">
																<div class="radio-item_1" id="removePrevBalDiv">
																	...
																	<label  for="wallet1" onclick="paymentmethodWallet('order_daily')" class="radio-label_1">Balance ₹{{$wallet_balance[0]->wallet}} </label>
																</div>
															</li>
													...
													<a class="next-btn16 text-light hover-btn" id="finalOrderBtn" onclick="paymentmethod('','order_daily')">Place Order</a>
												</div>
											</div>
										</div>
									</div>
	...
	<form id="checkoutForm2">
		...
		<input type="hidden" id="delivery_days" value="0" name="delivery_days">
		<input type="hidden" id="delivery_daily" value="no" name="delivery_daily">
		<input type="hidden" class="totalPriceCounter" id="totalPriceCounter" value="{{$totalPrice}}" name="totalPriceCounter">
		...
		<input type="hidden" id="couponcode" value="not used" name="coupon_code">
