					...
					<div class="col-md-12">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item text-capitalize active" aria-current="page">discounted products</li>
							</ol>
						</nav>
					</div>
				</div>
			...
			<div class="container">
					...
					<div class="col-lg-12">
						<div class="product-top-dt">
							<div class="product-left-title">
								<h2 class="text-capitalize">discounted Products</h2>
							</div>
							...
							<div class="product-sort float-left float-md-right">
								<div class="ui selection dropdown vchrt-dropdown">
									...
									<div class="menu">
										<div class="item" onclick="item_sort('popularity','{{$sort}}','discounted-products','{{$page}}')" data-value="0">Popularity</div>
										<div class="item" onclick="item_sort('price_high','{{$sort}}','discounted-products','{{$page}}')" data-value="1">Price - Low to High</div>
										<div class="item" onclick="item_sort('price_low','{{$sort}}','discounted-products','{{$page}}')" data-value="2">Price - High to Low</div>
										<div class="item" onclick="item_sort('name','{{$sort}}','discounted-products','{{$page}}')" data-value="3">Alphabetical</div>
										<div class="item" onclick="item_sort('date','{{$sort}}','discounted-products','{{$page}}')" data-value="4">Date</div>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="product-list-view">
					<div class="row showRow">
						...
						@endforeach
						@if($product->count()==0) <script type="text/javascript">window.location.href='/discounted-products';</script> @endif
						<div class="col-md-12">
